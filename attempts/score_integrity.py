...
def enforce_speaking_audio_integrity(sender, instance, **kwargs):
    ...
    feedback = feedback_dict(instance)
    # Version 3 follows the supplied CEFR B1 specification: unusable audio is
    # insufficient evidence, never an automatic zero. Leave those records to
    # the authoritative grader and its human-review workflow.
    if (
