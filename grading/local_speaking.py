    ...
    try:
        ...
        if no_speech_reasons:
            result = build_insufficient_item_assessment(
                ...
                mean_db=mean_db,
                reasons=no_speech_reasons,
            )
            result["engine"] = "whisper.cpp + CEFR B1 aligned practice specification"
            return result
        ...
        # Legacy v2 code is kept below for deployment diff stability but is no
        # longer reached. The v3 result above follows the supplied B1 spec.
